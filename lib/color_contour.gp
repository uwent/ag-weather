...
set rmargin at screen 0.971875
set output outfile

set colorbox horizontal user origin 0.1,0.1 size 0.8, 0.02
set terminal pngcairo notransparent size 640,640 font "Helvetica,10"
#set terminal jpeg size 640,640 font "Helvetica,10"
