...
RSpec.describe PrecipsController, type: :controller do
  ...
  describe "#index" do
    ...
    context "when request is valid" do
      ...
      it "has the correct response structure" do
        ...
        expect(json[:data][0].keys).to match([:date, :value, :cum_value])
      end
  ...
  describe "#show" do
    ...
    let(:filename) { "/precip_#{date.to_s(:number)}.png" }
  ...
  describe "#all_for_date" do
    ...
    before(:each) do
      FactoryBot.create(:precip, date: date)
      FactoryBot.create(:precip_data_import, readings_on: date)
      FactoryBot.create(:precip, date: date2)
      FactoryBot.create(:precip_data_import, readings_on: date2)
    end
  ...
  describe "#info" do
    ...
    it "returns data ranges for precip" do
      get :info
